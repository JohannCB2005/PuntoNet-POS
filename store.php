    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container justify-content-between">
            ...
            <a class="navbar-brand d-flex align-items-center gap-2" href="#">
                <img src="assets/logo.svg" alt="NISSI" height="30">
            ...
            <div class="d-flex gap-2 align-items-center">
                <?php if ($clienteLogueado): ?>
                    <div class="dropdown">
                        <button class="btn btn-outline-primary rounded-pill px-3 fw-semibold dropdown-toggle" type="button" data-bs-toggle="dropdown">
                            <i class="bi bi-person-circle me-1"></i> <?php echo htmlspecialchars(explode(' ', $clienteNombre)[0] ?? 'Mi Cuenta'); ?>
                        </button>
                        <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                            <li><a class="dropdown-item" href="views/public/V_mis_pedidos.php"><i class="bi bi-bag-check me-2"></i>Mis Pedidos</a></li>
                            <li><a class="dropdown-item" href="views/public/V_mi_cuenta.php"><i class="bi bi-person-gear me-2"></i>Mi Cuenta</a></li>
                ...
                <?php else: ?>
                    <a href="views/public/V_cuenta.php" class="btn btn-outline-primary rounded-pill px-3 fw-semibold">
                        ...
                        <div class="col-12 col-sm-6 col-lg-3">
                            <div class="product-card">
                                ...
                                <div class="product-info">
                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                        <div class="product-category">${escapeHtml(item.categoria)}</div>
                                        <div class="product-stock" style="background:${v.stock_ilimitado ? '#dcfce7;color:#16a34a' : '#dbeafe;color:#1d4ed8'}">${v.stock_ilimitado ? '<i class="bi bi-infinity me-1"></i>Stock ilimitado' : v.stock + ' disp.'}</div>
                                    </div>
                                    <h3 class="product-title">${escapeHtml(item.nombre)}</h3>
                                    <div class="mt-auto pt-3">
